...
<p>
  Use the <code>markers</code> prop to render vertical reference lines at specific
  timestamps, such as deployments, releases, or configuration changes. Markers
  can include short labels, descriptions for tooltips, colors, and line styles.
</p>
...
### Line
  ...
  <ComponentExample demo="LoadingChartDemo">
    <LoadingChartDemo client:only="solid-js" />
  </ComponentExample>

### Bar

  <ComponentExample demo="LoadingBarChartDemo">
    <LoadingBarChartDemo client:only="solid-js" />
  </ComponentExample>
</ComponentSection>
