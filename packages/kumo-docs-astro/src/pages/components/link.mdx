...
```tsx
import { Link } from "@photon-ai/kumo-solid/components/link";
```
  ...
  <table class="w-full text-sm">
    ...
    <tbody>
      ...
      <tr class="border-b border-kumo-hairline">
        ...
        <td class="px-4 py-3 font-mono text-xs">RenderProp</td>
    ...
    <div>
      ...
      <ul class="ml-4 list-disc space-y-1">
        ...
        <li>
          ...
          navigation prop (for example, Solid Router's `href`)
        </li>
        <li>
