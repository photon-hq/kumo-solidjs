...
<CodeBlock code={`import { Dialog } from "@photon-ai/kumo-solid";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { Dialog } from "@photon-ai/kumo-solid/components/dialog";`}
    lang="tsx"
  />
</ComponentSection>
...
```tsx
import { Dialog, Button } from "@photon-ai/kumo-solid";
