...
```tsx
import { Toasty, useKumoToastManager } from "@photon-ai/kumo-solid";
```

### Granular

```tsx
import { Toasty, useKumoToastManager } from "@photon-ai/kumo-solid/components/toast";
```
...
```tsx
import { Toasty, useKumoToastManager, Button } from "@photon-ai/kumo-solid";
...
import { Toasty } from "@photon-ai/kumo-solid";
  ...
  <table class="w-full text-left text-sm">
    ...
    <tbody class="text-kumo-subtle">
      ...
      <tr class="border-b border-kumo-hairline">
        ...
        <td class="py-3 pr-4 font-mono">JSX.Element</td>
        <td class="py-3 pr-4">—</td>
        <td class="py-3">
