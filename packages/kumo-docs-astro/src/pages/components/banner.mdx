...
<CodeBlock code={`import { Banner } from "@photon-ai/kumo-solid";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { Banner } from "@photon-ai/kumo-solid/components/banner";`}
    lang="tsx"
  />
</ComponentSection>
...
```tsx
import { Banner } from "@photon-ai/kumo-solid";
